...
simpleOpArraySchema mCount = object $
  [ "type" .= ("array" :: Text)
...
createOperationArraySchema arrayLength = object
  [ "type" .= ("array" :: Text)
  , "items" .= object
      [ "oneOf" .=
